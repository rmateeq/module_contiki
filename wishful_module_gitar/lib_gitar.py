...
class SensorDataType():
	typeSize = {"UINT8_T":1,"INT8_T" : 1,"UINT16_T" : 2,"INT16_T" : 2,"UINT32_T" : 4,"INT32_T" : 4,"UINT64_T" : 8,"INT64_T" : 8,"BOOL_T" : 1,"CHAR_T" : 1};
	typeID = {"UINT8_T":0,"INT8_T" : 1,"UINT16_T" : 2,"INT16_T" : 3,"UINT32_T" : 4,"INT32_T" : 5,"UINT64_T" : 6,"INT64_T" : 7,"BOOL_T" : 8,"CHAR_T" : 9,"STRING_T" : 10,"STRUCT_T" : 11};
	typeName = {0:"UINT8_T",1:"INT8_T",2:"UINT16_T",3:"INT16_T",4:"UINT32_T",5:"INT32_T",6:"UINT64_T",7:"INT64_T",8:"BOOL_T",9:"CHAR_T",10:"STRING_T",11:"STRUCT_T"};
	...
	typeAsStruct = [UINT8_T,INT8_T,UINT16_T,INT16_T,UINT32_T,INT32_T,UINT64_T,INT64_T,BOOL_T,CHAR_T,STRING_T,STRUCT_T]
	...
	def create_nodes(self, config_file, supported_interfaces, control_extensions):
		...
		for connector_module in control_extensions.keys():
			try:
				...
				self.log.fatal("Could not read parameters for %s, from %s error: %s" % (connector_module, control_extensions[connector_module], e))
